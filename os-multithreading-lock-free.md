...
![Software - hardware layers](https://raw.githubusercontent.com/monocasual/internalpointers-files/master/2019/07/software-hardware-layers.png)

\1. Multiple layers of a computer program. Dashed lines are software, solid lines are hardware.

Depending on the CPU architecture, some machine instructions are atomic, that is they are performed in a single, uncuttable and uninterruptible step. Some others are not atomic instead: the processor does more work under the hood in form of even smaller operations, known as **[micro-operations](https://en.wikipedia.org/wiki/Micro-operation)**. Let's focus on the former category: an atomic instruction is a CPU operation that cannot be further broken down. More specifically, atomic instructions can be grouped into two major classes: **store and load** and **read-modify-write (RMW)**.
...
![Three levels of atomic instructions](https://raw.githubusercontent.com/monocasual/internalpointers-files/master/2019/07/atomics-levels.png)
...
![Lock-free, wait-free](https://raw.githubusercontent.com/monocasual/internalpointers-files/master/2019/07/lock-free-wait-free.png)
...
Preshing on Programming - [You Can Do Any Kind of Atomic Read-Modify-Write Operation](https://preshing.com/20150402/you-can-do-any-kind-of-atomic-read-modify-write-operation/)
StackOverflow - [Do I need a mutex for reading?](https://stackoverflow.com/questions/1525189/do-i-need-a-mutex-for-reading)
StackOverflow - [Will atomic operations block other threads?](https://stackoverflow.com/questions/39795265/will-atomic-operations-block-other-threads)
StackOverflow - [Spinlock vs Busy wait](https://stackoverflow.com/questions/38124337/spinlock-vs-busy-wait)
GCC Wiki - [Atomics](https://gcc.gnu.org/wiki/Atomic/GCCMM/AtomicTypes)
GCC Wiki - [Memory model synchronization modes](https://gcc.gnu.org/wiki/Atomic/GCCMM/AtomicSync)
Threading Building Blocks - [Atomic Operations](https://www.threadingbuildingblocks.org/docs/help/tbb_userguide/Atomic_Operations.html)
...
Wikipedia - [Read-modify-write](https://en.wikipedia.org/wiki/Read–modify–write)
Wikipedia - [Test-and-set](https://en.wikipedia.org/wiki/Test-and-set)
Tyler Neely - [Fear and Loathing in Lock-Free Programming](https://medium.com/@tylerneely/fear-and-loathing-in-lock-free-programming-7158b1cdd50c)
Jason Gregory - [Game Engine Architecture, Third Edition](https://www.ebooks.com/en-us/95912264/game-engine-architecture-third-edition/jason-gregory/)
AA.VV. - [Evaluating the Cost of Atomic Operations on Modern Architectures](https://spcl.inf.ethz.ch/Publications/.pdf/atomic-bench.pdf)
Herb Sutter, CppCon 2014 - [Lock-Free Programming (or, Juggling Razor Blades), Part 1](https://www.youtube.com/watch?v=c1gO9aB9nbs)
Herb Sutter, CppCon 2014 - [Lock-Free Programming (or, Juggling Razor Blades), Part 2](http://www.youtube.com/watch?v=CmxkPChOcvw)
Maurice Herlihy - [Wait-free synchronization](https://cs.brown.edu/~mph/Herlihy91/p124-herlihy.pdf)
Fedor Pikus, CppCon 2014 - [Read, Copy, Update, then what? RCU for non-kernel programmers](https://www.youtube.com/watch?v=rxQ5K9lo034)
1024cores - [Lockfree Algorithms](http://www.1024cores.net/home/lock-free-algorithms)
Microsoft - [Lockless Programming Considerations for Xbox 360 and Microsoft Windows](https://docs.microsoft.com/en-us/windows/win32/dxtecharts/lockless-programming)
Brian Goetz, IBM - [Going Atomic](https://www.ibm.com/developerworks/java/library/j-jtp11234/)