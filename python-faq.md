# [Programming FAQ](https://docs.python.org/2/faq/programming.html#id1)
...
There is a page on the wiki devoted to [performance tips](https://wiki.python.org/moin/PythonSpeed/PerformanceTips).
